...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>Welcome {{ username }}</p>\n<a routerLink = \"inventory\">View Inventory</a>\n<a routerLink = \"cart\">View Cart</a>\n\n\n<router-outlet></router-outlet>\n\n\n\n\n\n\n\n\n");
...
let GuestSignInComponent = class GuestSignInComponent {
    constructor(route, router, usersService) {
        this.route = route;
        this.router = router;
        this.usersService = usersService;
    ...
    onSubmit() {
        let username = this.n.nativeElement.value;
        this.router.navigate([`inventory`], { relativeTo: this.route, queryParamsHandling: "preserve" });
        this.usersService.show();
    }
};
GuestSignInComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _users_service__WEBPACK_IMPORTED_MODULE_3__["UsersService"] }
];
...
let InventoryComponent = class InventoryComponent {
    constructor(sneakerService, route, router, usersService) {
    ...
    ngOnInit() {
        ...
        this.paramsSubscrition = this.route.params.subscribe((params) => {
    ...
    onGetSneakers() {
        this.sneakerService.getSneakers()
            .subscribe((sneaker) => this.sneakers = sneaker, (error) => console.log(error));
...
let SneakerService = class SneakerService {
    constructor(http) {
        this.http = http;
...
module.exports = __webpack_require__(/*! C:\Users\river\Downloads\10-20191010T184102Z-001\UPDATED--Sneaker App 10-10\src\main.ts */"./src/main.ts");
